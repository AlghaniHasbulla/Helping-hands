  ...
  return (
    <div className="min-h-screen bg-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-blue-200 border-2 border-dashed border-blue-300 rounded-xl w-full h-96 flex items-center justify-center text-blue-700 mb-16">
          <span>Impact Infographic</span>
        </div>
      </div>
      ...
      <div className="bg-blue-100 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-blue-700 max-w-3xl mx-auto">
              We collaborate with organizations that share our commitment to positive change
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="bg-white p-8 rounded-xl shadow-sm flex items-center justify-center">
                <div className="bg-blue-200 border-2 border-dashed border-blue-300 w-24 h-24 rounded-full flex items-center justify-center text-blue-700">
                  Logo {i+1}
                </div>
              </div>
            ))}
