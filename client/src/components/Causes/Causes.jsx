...
const Causes = () => {
  ...
  // Simulate loading causes from an API
  useEffect(() => {
    ...
    const mockCauses = [
      {
        ...
        description: 'Provide school supplies, uniforms, and meals to children in rural areas who lack access to education.',
        category: 'education',
        raised: 12500,
        goal: 25000,
        donors: 342,
      ...
      {
        id: 2,
        title: 'Clean Water Wells in Sub-Saharan Africa',
        description: 'Build sustainable water wells to provide clean drinking water to communities affected by drought.',
      ...
      },
      {
        ...
        description: 'Deliver essential medical supplies and equipment to refugee camps facing healthcare shortages.',
        category: 'health',
        raised: 32000,
        goal: 50000,
        donors: 224,
        location: 'Global Refugee Camps',
        urgency: 'critical'
      },
      {
        id: 4,
        title: 'Wildlife Conservation in Amazon',
        description: 'Protect endangered species and their habitats in the Amazon rainforest from deforestation.',
        category: 'animals',
        raised: 18750,
        goal: 30000,
        donors: 98,
      ...
      {
        id: 5,
        title: 'Food Security for Urban Poor',
        description: 'Provide nutritious meals and food packages to families struggling with food insecurity in urban areas.',
        category: 'poverty',
        raised: 15600,
        goal: 30000,
        donors: 203,
        location: 'Urban Centers Worldwide',
        urgency: 'high'
      },
      {
        id: 6,
        title: 'Legal Aid for Human Rights Defenders',
        description: 'Support legal representation and advocacy for human rights activists facing persecution.',
      ...
      },
      {
        ...
        description: 'Emergency response and rebuilding efforts for communities devastated by recent hurricanes.',
        category: 'disaster',
        raised: 89500,
        goal: 150000,
        donors: 431,
      ...
      },
      {
        ...
        description: 'Provide technology training and devices to seniors to help them stay connected and access services.',
        category: 'education',
        raised: 8700,
        goal: 20000,
        donors: 67,
